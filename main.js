...
function sendMessage() {
    ...
    if (userMessage.trim() !== '') {
        ...
        // Process the user message and get the bot's response (you need to implement this part)
...
// Example: Implement a basic set of responses
function getBotResponse(userMessage) {
    // You would typically use more advanced logic, possibly involving backend services or APIs
    const responses = {
        ...
        "what distinguishes sciastra's mentors, and where are they from?":'SciAstra has over 60 mentors from premier research institutes worldwide, including Harvard, Oxford, Max Planck, IISc, and IISERs.',
    ...
    return responses[lowerCaseUserMessage] || 'I am sorry, I did not understand that. Can you please ask another question?';
}
